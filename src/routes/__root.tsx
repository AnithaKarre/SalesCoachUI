...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SalesCoach AI — Field Coaching for GCash DSPs" },
      { name: "description", content: "Multi-agent sales coaching platform for GCash field agents and area managers." },
    ],
